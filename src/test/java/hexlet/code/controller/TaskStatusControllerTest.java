...
public class TaskStatusControllerTest {
    ...
    public void testCreateStatus() throws Exception {
        ...
        final var postRequest = MockMvcRequestBuilders.post(BASE_URL + TaskStatusController.TASK_STATUS_CONTROLLER_PATH)
                .content(TestUtils.asJson(statusDto))
                .contentType(APPLICATION_JSON);

        final var response = utils.perform(postRequest, TestUtils.TEST_USERNAME)
    ...
    public void testGetStatusById() throws Exception {
        ...
        utils.perform(postRequest, TestUtils.TEST_USERNAME)
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse();
    ...
    public void testUpdateStatus() throws Exception {
        ...
        final var putRequest = put(BASE_URL + TaskStatusController.TASK_STATUS_CONTROLLER_PATH
                ...
                .content(TestUtils.asJson(statusDto))
                .contentType(APPLICATION_JSON);
        final var response = utils.perform(putRequest, TestUtils.TEST_USERNAME)
                .andExpect(status().isOk())
                .andReturn()
                .getResponse();
    ...
    public void getAllStatuses() throws Exception {
        ...
        final var response = utils.perform(MockMvcRequestBuilders.get(BASE_URL
                        + TaskStatusController.TASK_STATUS_CONTROLLER_PATH), TestUtils.TEST_USERNAME)
                .andExpect(status().isOk())
                .andReturn()
                .getResponse();
    ...
    public void deleteStatus() throws Exception {
        ...
        utils.perform(delete(BASE_URL + TaskStatusController.TASK_STATUS_CONTROLLER_PATH + TaskStatusController.ID,
